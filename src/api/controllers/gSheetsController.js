...
async function create(req, res) {
    ...
    const objToAppend = req.boby
    res.json(await gSheetsServices.create(folderName, sheetName, objToAppend))
}
...
async function update(req, res) {
    ...
    res.json(await gSheetsServices.update(folderName, sheetName, id, objToUpdate))
}
